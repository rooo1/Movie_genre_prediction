...
multilabel_binarizer1= joblib.load("genre_prediction/modelfiles/multilabel_binarizer1.pkl")
tfidf_vectorizer = joblib.load("genre_prediction/modelfiles/tfidf_vectorizer.pkl")
bow_vectorizer = joblib.load("genre_prediction/modelfiles/bow_vectorizer.pkl")
clf_tfidf = joblib.load("genre_prediction/modelfiles/clf_tfidf.pkl")
clf_bow = joblib.load("genre_prediction/modelfiles/clf_bow.pkl")
